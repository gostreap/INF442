 ...
 * perform kNN classification on the provided column with the user-provided k, and print the resulting 
 * test set error rate.
*/
...
int main(int argc, char* argv[]) {
	...
	assert(("[NOK]", train_dataset.getDim() == class_dataset.getDim()));
	...
	std::cout << "Error Rate, over test training set: "<< mer <<std::endl;
